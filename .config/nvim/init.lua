...
-- vim.keymap.set('n', '<C-s-s>', resession.save, { desc = 'Save session' })
-- vim.keymap.set('n', '<C-s-l>', resession.load, { desc = 'Load session' })
-- vim.keymap.set('n', '<C-s-d>', resession.delete, { desc = 'Delete session' })
...
vim.keymap.set('n', 'J', 'mzJ`z') -- keep cursor in place when adding lines with J
vim.keymap.set('n', '<C-d>', '<C-d>zz') -- keep cursor in the middle of the screen when scrolling
vim.keymap.set('n', '<C-u>', '<C-u>zz') -- keep cursor in the middle of the screen when scrolling
vim.keymap.set('n', 'n', 'nzzzv') -- keep cursor in the middle of the screen when searching
vim.keymap.set('n', 'N', 'Nzzzv') -- keep cursor in the middle of the screen when searching
vim.keymap.set('x', '<leader>p', '"_dP') -- do not repace the register with the overwritten text when pasting over selection
vim.keymap.set('n', '<Esc>', '<cmd>nohlsearch<CR>') -- Turn off highlight till next search
-- vim.keymap.set('n', '<leader>\\', ': noh<CR>')
vim.keymap.set('n', 'Q', '<nop>')

-- NOTE: PP - mappings to make moving in and out of a terminal easier once toggled, whilst still keeping it open
...
-- NOTE: PP - Open floating terminal
...
vim.keymap.set('n', '<leader>t', '<cmd>lua _floatTerm_toggle()<CR>', { desc = 'Open terminal in new window' })
-- vim.keymap.set('t', '<leader>t', '<cmd>lua _floatTerm_toggle<cmd>', { desc = 'Open terminal in new window' })

-- NOTE: PP - Lazygit in toggleterm
--
-- local Terminal = require('toggleterm.terminal').Terminal
